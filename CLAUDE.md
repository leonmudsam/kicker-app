...
- **§C33 Im Feed hat jeder ein Gesicht.** Jede Story, die einen Spieler
  ...
  **Was im selben Moment passiert, kommt in eine Karte.** Ein Spieltag trug
  ...
  Ein Rekord auf einem gleitenden Fenster steht in derselben Karte: er ist
  ein Liga-Rekord, und was ihn unterscheidet, ist allein das fehlende
  „ausgebaut" [§C35]. Zeilen aus älteren Läufen ohne `causalKey` finden
  weiter über Partie oder Minute zusammen. Ein vollständiges Bundle entsteht
  auch dann, wenn eine Zeile Breaking ist. Spieltags-Ereignisse brauchen zusätzlich **ein
